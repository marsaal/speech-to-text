...
def load_audio(filepath, target_sr=16000):
    ...
    return torch.tensor(waveform), target_sr
...
# Prepare text target (for training)
def tokenize_transcript(text, processor):
    return processor.tokenizer(text, return_tensors="pt").input_ids
...
if __name__ == "__main__":
    ...
    print(tokenize_transcript(string, processor))
